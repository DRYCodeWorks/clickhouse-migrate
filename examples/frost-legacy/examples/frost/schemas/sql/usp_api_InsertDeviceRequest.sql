...
BEGIN TRY	
	...
	INSERT INTO [dbo].[DeviceRequests]
     ...
     VALUES
		...
		if (isnull(@RequestTypeCode,'') in ('DEVICE_REQUEST_PHOTO', 'DEVICE_REQUEST_BURST_PHOTO'))
		begin	
		...
		INSERT INTO [dbo].[Notifications]
			...
			VALUES
				...
				,3 --WEB
				,(
                    SELECT n.ID FROM NotificationType n
                    JOIN RequestTypeNotificationTypeMap m on n.Name = m.NotificationTypeName
                    WHERE m.RequestTypeCode = @RequestTypeCode
