...
Revision ID: 04bcd602ec29
Revises: fe011113158d
Create Date: 2025-07-16 18:17:43.053361
...
revision = "04bcd602ec29"
down_revision = "fe011113158d"
branch_labels = None
depends_on = None

role_name = "frost_sds_role"
user_login = "sds_handler_login"
user_name = "sds_handler"
secret_name = "sds-handler"
...
def upgrade() -> None:
    ...
    op.execute(read_sql_file("users/CreateSDSRole").replace("?", f"'{password}'"))
