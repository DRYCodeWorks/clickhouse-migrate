...
Revision ID: a29dca7286cb
Revises: 09edc47062eb
Create Date: 2025-07-28 12:01:18.343320
...
revision = "a29dca7286cb"
down_revision = "09edc47062eb"
branch_labels = None
depends_on = None

role_name = "frost_api_authorizer_role"
user_login = "api_authorizer_handler_login"
user_name = "api_authorizer_handler"
secret_name = "lambda-authorizer-user"
...
def upgrade() -> None:
    ...
    op.execute(read_sql_file("users/CreateAuthorizerRole").replace("?", f"'{password}'"))
